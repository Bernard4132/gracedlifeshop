...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference('Poster.count') do
      post posters_url, params: { poster: { description: @poster.description, posterimage: @poster.posterimage, price: @poster.price, title: @poster.title } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { description: @poster.description, posterimage: @poster.posterimage, price: @poster.price, title: @poster.title } }
